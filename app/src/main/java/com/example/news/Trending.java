...
public class Trending extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(() -> getJson("IE", API_KEY));
        ...
        call.enqueue(new Callback<Headline>() {
            ...
            public void onResponse(Call<Headline> call, Response<Headline> response) {
                if (response.isSuccessful() && response.body().getArticles() != null) {
                    ...
                    newsAdapter = new NewsAdapter(Trending.this, articleList);
            ...
            public void onFailure(Call<Headline> call, Throwable t) {
                swipeRefreshLayout.setRefreshing(false);
                Toast.makeText(Trending.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
